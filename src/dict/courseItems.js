const courseItems = [
    ...
    {"id": 205, "unitId": 3, "eng": "We use the present continuous for things happening at or around the time of speaking.", "transl": "Мы используем текущую непрерывность для вещей, происходящих во время разговора или около него."},
    {"id": 206, "unitId": 3, "eng": "We use the present simple for things in general or things that happen repeatedly.", "transl": "Мы используем настоящее простое для вещей вообще или вещей, которые происходят неоднократно."},
    ...
    {"id": 220, "unitId": 3, "eng": "We use continuous forms for actions and happenings that have started but not finished", "transl": "Мы используем непрерывные формы для действий и событий, которые начались, но не завершены"},
    {"id": 221, "unitId": 3, "eng": "The following verbs are not normally used in the present continuous: like, want, need, prefer, " +
            ...
            "belong, fit, contain, consist, seem", "transl": "Следующие глаголы обычно не используются в настоящем продолжении: как, хотеть, нуждаться, предпочитать, знать, понимать, предполагать, подразумевать, понимать, верить, помнить, принадлежать, соответствовать, содержать, состоять, казаться"},
